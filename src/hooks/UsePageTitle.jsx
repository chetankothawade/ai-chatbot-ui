...
const pageTitleConfig = [
  ...
  { path: "/client/", title: "AI Chatbot : Home" },
...
function formatTitle(baseTitle) {
  if (!baseTitle) return "AI Chatbot";
...
/** Main Hook */
export default function usePageTitle(defaultTitle = "AI Chatbot") {
